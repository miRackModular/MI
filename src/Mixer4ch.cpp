...
struct Mixer4chWidget : ModuleWidget{
	...
	Mixer4chWidget(Mixer4ch *module) {
		...
		addParam(createParam<as_KnobSmall>(Vec(columnPos[0]-3, panPosY), module, Mixer4ch::CH1_PAN_PARAM));
		addParam(createParam<as_KnobSmall>(Vec(columnPos[1]-3, panPosY), module, Mixer4ch::CH2_PAN_PARAM));
		addParam(createParam<as_KnobSmall>(Vec(columnPos[2]-3, panPosY), module, Mixer4ch::CH3_PAN_PARAM));
		addParam(createParam<as_KnobSmall>(Vec(columnPos[3]-3, panPosY), module, Mixer4ch::CH4_PAN_PARAM));
		...
		addParam(createParam<LEDBezel>(Vec(columnPos[0]+1, mutePosY), module, Mixer4ch::CH1MUTE ));
		addChild(createLight<LedLight<RedLight>>(Vec(columnPos[0]+3.2, mutePosY+2), module, Mixer4ch::MUTE_LIGHT1));
		addParam(createParam<LEDBezel>(Vec(columnPos[1]+1, mutePosY), module, Mixer4ch::CH2MUTE ));
		addChild(createLight<LedLight<RedLight>>(Vec(columnPos[1]+3.2, mutePosY+2), module, Mixer4ch::MUTE_LIGHT2));
		addParam(createParam<LEDBezel>(Vec(columnPos[2]+1, mutePosY), module, Mixer4ch::CH3MUTE ));
		addChild(createLight<LedLight<RedLight>>(Vec(columnPos[2]+3.2, mutePosY+2), module, Mixer4ch::MUTE_LIGHT3));
		addParam(createParam<LEDBezel>(Vec(columnPos[3]+1, mutePosY), module, Mixer4ch::CH4MUTE ));
		addChild(createLight<LedLight<RedLight>>(Vec(columnPos[3]+3.2, mutePosY+2), module, Mixer4ch::MUTE_LIGHT4));
		...
		addParam(createParam<LEDBezel>(Vec(mstrX-1, mutePosY), module, Mixer4ch::MASTER_MUTE ));
		addChild(createLight<LedLight<RedLight>>(Vec(mstrX+1.2, mutePosY+2), module, Mixer4ch::MUTE_LIGHT_MASTER));
